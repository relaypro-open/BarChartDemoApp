...
public class ChartGridView extends View {
    ...
    private boolean mDrawVertialLines;
    ...
    public ChartGridView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mDrawBorder = a.getBoolean(R.styleable.ChartGridView_drawBorder, true);
        mDrawVertialLines = a.getBoolean(R.styleable.ChartGridView_drawVerticalGridLines, true);
        mDrawHorizontalLines = a.getBoolean(R.styleable.ChartGridView_drawHorizontalGridLines, true);
